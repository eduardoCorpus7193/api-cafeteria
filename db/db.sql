...
CREATE TABLE IF NOT EXISTS `cafeteria`.`menuItems` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `item_category_id_idx` (`categoryId` ASC),
...
CREATE TABLE IF NOT EXISTS `cafeteria`.`orderItems` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `orderItems_orders_id_idx` (`orderId` ASC),
  INDEX `orderItems_menuItems_id_idx` (`itemId` ASC),
...
CREATE TABLE IF NOT EXISTS `cafeteria`.`inventory` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `inventory_menuItems_itemId_idx` (`itemId` ASC),
